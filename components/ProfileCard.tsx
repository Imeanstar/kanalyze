...
import { MessageCircle, Users, Percent, Clock } from 'lucide-react';
...
export default function ProfileCard({ member, rank, totalMessages, totalSpeakers }: ProfileCardProps) {
